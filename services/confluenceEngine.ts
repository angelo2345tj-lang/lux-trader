...
export function computeConfluence(
  ...
  if (!direction) {
    return {
      ...
      classification: 'MERCADO INDEFINIDO',
      securityScore: 40,
      indicators,
      confluences: ['Sem direção clara'],
      blocked: !instant,
      blockReason: instant ? undefined : 'Mercado sem tendência definida',
      trend: 'LATERAL',
      strength: 0,
    };
  }
